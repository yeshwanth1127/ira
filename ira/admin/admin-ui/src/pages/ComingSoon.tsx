...
export default function ComingSoon() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12 sm:px-6 sm:py-16 md:px-8 lg:px-12 xl:px-32" style={{ fontFamily: "JetBrains Mono, monospace" }}>
      <h1
      ...
      <p className="mb-8 text-center text-lg sm:text-xl text-white/90 max-w-md">
        We&apos;re working on the demo. Check back soon to see Ira in action.
      </p>
      <Link
        to="/"
