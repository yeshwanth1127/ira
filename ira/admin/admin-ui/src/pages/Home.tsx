    ...
    <div className="bg-black">
      ...
      >
        ...
        <div className="flex flex-col justify-center max-w-4xl items-start">
          {/* Div 1: Logo + IRA + by Exora */}
          <div className="inline-flex items-end gap-0.5 sm:gap-1 mb-6 sm:mb-8 -ml-5 sm:-ml-7 md:-ml-10 lg:-ml-12">
            <div
              className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-48 xl:h-48 flex-shrink-0 bg-[#32d74b] [mask-size:contain] [mask-repeat:no-repeat] [-webkit-mask-size:contain] [-webkit-mask-repeat:no-repeat]"
              style={{
            ...
            <div className="flex flex-col justify-end pb-1">
              <h1
                ...
                style={{
                  ...
                  color: "transparent",
                  WebkitTextStroke: "1px #32d74b",
                }}
              >
                IRA
              </h1>
              <p className="text-[10px] sm:text-xs mt-1 sm:mt-2" style={{ fontFamily: '"JetBrains Mono", monospace', color: "#ff9f0a" }}>
                by Exora
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            >
              Ira turns your computer into an AI assistant.
            </p>
          </div>
        </div>
      ...
      >
        ...
        >
          <div className="space-y-4 sm:space-y-5">
            <h3 className="text-xl sm:text-2xl font-semibold" style={{ color: "#ff9f0a" }}>Students</h3>
          ...
          <div className="space-y-4 sm:space-y-5">
            <h3 className="text-xl sm:text-2xl font-semibold" style={{ color: "#ff9f0a" }}>Developers</h3>
          ...
          <div className="space-y-4 sm:space-y-5">
            <h3 className="text-xl sm:text-2xl font-semibold" style={{ color: "#ff9f0a" }}>Creators</h3>
            <ul className="space-y-2 sm:space-y-3 text-white text-base sm:text-lg">
          ...
          <div className="space-y-4 sm:space-y-5">
            <h3 className="text-xl sm:text-2xl font-semibold" style={{ color: "#ff9f0a" }}>General</h3>
            <ul className="space-y-2 sm:space-y-3 text-white text-base sm:text-lg">
        ...
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 max-w-3xl mb-16 sm:mb-20 md:mb-24" style={{ fontFamily: "JetBrains Mono, monospace" }}>
      ...
      >
        ...
        <p
          ...
          style={{ fontFamily: "JetBrains Mono, monospace" }}
        >
          Install Ira and experience AI that actually understands what you&apos;re doing.
        </p>
        <Link
          to="/download"
